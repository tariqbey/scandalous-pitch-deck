...
const CHARS = [
  {
    ...
    roleColor: "#e05c8a",
    textOnBadge: "#000",
    desc: "Married to Calvin. Mother of Darius. Renee is the keeper of the original lie. She lies to Calvin, manipulates Darius, blocks Michael, dodges Tonya, delays the DNA test, and keeps creating new lies to cover the old one. She has lived 20 years inside this decision — and she knows how to hide it.",
    arc: "From keeper of the lie to the woman who must choose between her marriage and her son's identity.",
    audience: "Primary: 25–50 Black women. Secondary: Drama fans 18–54.",
    reach: 90,
  },
  {
    id: "michael",
    ...
    roleColor: "#D4AF37",
    textOnBadge: "#000",
    desc: "Married to Tonya. Father of Jada. Michael cannot sleep. He cannot watch Jada with Darius. He pushes Renee for DNA — but he cannot expose her without confessing to Tonya. He is equally guilty. He is equally trapped. He has the new evidence, but she has the longer lie.",
    arc: "From truth-seeker to a man who realizes he is just as guilty as the woman he is trying to pressure.",
